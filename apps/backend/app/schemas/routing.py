...
class RouteSegment(BaseModel):
    ...
    board_lat: float | None = Field(None, description="Boarding latitude")
    board_lon: float | None = Field(None, description="Boarding longitude")
    alight_at: str | None = Field(None, description="Alighting location name")
    alight_lat: float | None = Field(None, description="Alighting latitude")
    alight_lon: float | None = Field(None, description="Alighting longitude")
